...
f = h5py.File('snapshots/snapshots_s31.h5')
p = dist.Field(bases=(z_basis, disk_basis))
p.load_from_hdf5(f, 0, task='<Field 22682004821408>')
qz = dist.Field(bases=(z_basis, disk_basis.edge))
qz.load_from_hdf5(f, 0, task='<Field 22682004820592>')
...
A = np.pi*0.2**2
print(cond_flux(z=0)['g']/A/112.95141083744463/2)
