...
# Initial conditions
f = h5py.File('snapshots_rst2_s31.h5')
p.load_from_hdf5(f, 0, task='<Field 22332332398272>')
dt = f['scales/timestep'][0]/10

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots', sim_dt=0.001, max_writes=1, parallel='gather')
snapshots.add_tasks(solver.state)

slices = solver.evaluator.add_file_handler('slices', sim_dt=0.00005, max_writes=100, parallel='gather')
