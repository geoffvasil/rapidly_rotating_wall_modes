...
# Initial conditions
f = h5py.File('snapshots_rst3/snapshots_rst3_s22.h5')
p.load_from_hdf5(f, 0, task='<Field 22471363220128>')
dt = f['scales/timestep'][0]/10

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_rst4', sim_dt=0.0002, max_writes=1, parallel='gather')
snapshots.add_tasks(solver.state)

slices = solver.evaluator.add_file_handler('slices_rst4', sim_dt=0.00005, max_writes=100, parallel='gather')
