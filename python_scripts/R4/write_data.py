...
f = h5py.File('snapshots_rst2/snapshots_rst2_s10.h5')
p = dist.Field(bases=(z_basis, disk_basis))
p.load_from_hdf5(f, 0, task='<Field 22273369986992>')
qz = dist.Field(bases=(z_basis, disk_basis.edge))
qz.load_from_hdf5(f, 0, task='<Field 22273369990064>')
qphi = dist.Field(bases=(z_basis, disk_basis.edge))
qphi.load_from_hdf5(f, 0, task='<Field 22273369986176>')
