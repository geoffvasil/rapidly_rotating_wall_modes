...
p.load_from_hdf5(f, 0, task='<Field 22538606057296>')
dt = f['scales/timestep'][0]/10

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_rst2', sim_dt=0.001, max_writes=1, parallel='gather')
snapshots.add_tasks(solver.state)

slices = solver.evaluator.add_file_handler('slices_rst2', sim_dt=0.00005, max_writes=100, parallel='gather')
