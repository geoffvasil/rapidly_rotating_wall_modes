...
# Initial conditions
f = h5py.File('snapshots_rst2_s39.h5')
p.load_from_hdf5(f, 0, task='<Field 22861837228048>')
dt = f['scales/timestep'][0]/10

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_rst3', sim_dt=0.001, max_writes=1, parallel='gather')
